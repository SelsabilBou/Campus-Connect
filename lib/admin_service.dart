...
class AdminService {
  ...
  // --------- petits helpers publics (NEW) ----------

  /// Pour construire une URL publique depuis d'autres fichiers.
  ...
  /// GET brut réutilisable dans d'autres écrans (ex: StudentAllScreen)
  Future<http.Response> getRaw(Uri uri) {
    return http.get(uri).timeout(_timeout);
  }

  /// Expose le decode list pour d'autres écrans.
  List<Map<String, dynamic>> decodeList(String body) => _decodeList(body);
